local strings = {
	...
	SI_BINDING_NAME_VOTANS_TOGGLE_MAP_SHOW_IN_HOUSING = "Показывать мини-карту в жилище",
	...
	SI_VOTANSMINIMAP_SHOW_IN_HOUSING = "Показать в домах",
	SI_VOTANSMINIMAP_SHOW_IN_HOUSING_TOOLTIP = "Отображает мини-карту внутри домов.",
