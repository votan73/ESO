local strings = {
	...
	SI_BINDING_NAME_VOTANS_TOGGLE_MAP_SHOW_IN_HOUSING = "Kartenansicht in Wohnungen umschalten",
	...
	SI_VOTANSMINIMAP_SHOW_IN_HOUSING = "In Häusern anzeigen",
	SI_VOTANSMINIMAP_SHOW_IN_HOUSING_TOOLTIP = "Zeigt die Minimap in Häusern an.",
