...
SafeAddString(SI_VOTANSMINIMAP_ALLOW_FLOOR_NAVIGATION, "Erlaube Navigation durch die Ebenen")
SafeAddString(SI_VOTANSMINIMAP_ALLOW_FLOOR_NAVIGATION_TOOLTIP, "Zeigt in der Mini Map die Buttons zum navigieren durch die Ebenen, wenn die Karte Ebenen hat.")
