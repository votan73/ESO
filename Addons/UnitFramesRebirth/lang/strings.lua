...
ZO_CreateStringId("SI_UNITFRAMESREBIRTH_CHAMPION_POINTS_WITH_LEVEL", "<<X:1>> <<2>>")
...
ZO_CreateStringId("SI_UNITFRAMESREBIRTH_SETTINGS_SWITCH_ASSIGNMENT_ICON", "Switch group frame icon")
ZO_CreateStringId("SI_UNITFRAMESREBIRTH_SETTINGS_SWITCH_ASSIGNMENT_ICON_TT", "Switches the group frame icon to a class icon.")
ZO_CreateStringId("SI_UNITFRAMESREBIRTH_SETTINGS_LEVEL", "Show level")
ZO_CreateStringId("SI_UNITFRAMESREBIRTH_SETTINGS_LEVEL_TT", "Shows the level of a group member on the group frame.")
