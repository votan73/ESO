...
ZO_CreateStringId("SI_UNITFRAMESREBIRTH_SETTINGS_UNIT_SHIELDS", "Power Shields")
ZO_CreateStringId("SI_UNITFRAMESREBIRTH_SETTINGS_UNIT_SHIELDS_TT", "Shows power shields applied on group members and pets.")
